...
export default function LandingPage() {
  ...
  return (
    <div className='bg-airt-secondary dark:text-white dark:bg-boxdark-2'>
      {/* Header */}
      ...
      <main className='isolate dark:bg-boxdark-2'>
        ...
        <div className='mt-12 mx-auto max-w-7xl px-6 lg:px-8 flex flex-col items-between gap-y-6'>
          <h2 className='mb-6 text-center font-semibold tracking-wide text-airt-font-base dark:text-white'>
            Built with / Used by:
          </h2>
        ...
        <div id='features' className='mx-auto mt-48 max-w-7xl px-6 lg:px-8'>
          <div className='mx-auto max-w-2xl text-center'>
            <p className='mt-2 text-4xl font-bold tracking-tight text-airt-font-base sm:text-5xl dark:text-white'>
              The <span className='text-airt-primary'>Best</span> Features
            </p>
            <p className='mt-6 text-lg leading-8 text-airt-font-base dark:text-white'>
              Don't work harder.
              <br /> Work smarter.
            </p>
          </div>
        ...
        <div className='mx-auto mt-32 max-w-7xl sm:mt-56 sm:px-6 lg:px-8'>
          <div className='relative sm:left-5 -m-2 rounded-xl bg-airt-primary lg:ring-1 lg:ring-airt-primary lg:-m-4 '>
            <div className='relative sm:top-5 sm:right-5 bg-airt-font-base dark:bg-boxdark px-8 py-20 shadow-xl sm:rounded-xl sm:px-10 sm:py-16 md:px-12 lg:px-20'>
              <h2 className='text-left text-xl font-semibold tracking-wide leading-7 text-airt-font-base dark:text-white'>
                What Our Users Say
              </h2>
              <div className='relative flex flex-wrap gap-6 w-full mt-6 z-10 justify-between lg:mx-0'>
                {testimonials.map((testimonial) => (
                  <figure className='w-full lg:w-1/4 box-content flex flex-col justify-between p-8 rounded-xl bg-airt-font-base '>
        ...
        {/* FAQ */}
        <div className='mt-32 mx-auto max-w-2xl divide-y divide-airt-font-base dark:divide-gray-200/10 px-6 pb-8 sm:pb-24 sm:pt-12 lg:max-w-7xl lg:px-8 lg:py-32'>
          <h2 className='text-2xl font-bold leading-10 tracking-tight text-airt-font-base dark:text-white'>
            Frequently asked questions
          </h2>
          <dl className='mt-10 space-y-8 divide-y divide-airt-font-base'>
            {faqs.map((faq) => (
              <div key={faq.id} className='pt-8 lg:grid lg:grid-cols-12 lg:gap-8'>
                <dt className='text-base font-semibold leading-7 text-airt-font-base lg:col-span-5 dark:text-white'>
                  {faq.question}
                </dt>
                <dd className='flex items-center justify-start gap-2 mt-4 lg:col-span-7 lg:mt-0'>
                  <p className='text-base leading-7 text-airt-font-base dark:text-white'>{faq.answer}</p>
                  {faq.href && (
                    <a href={faq.href} className='text-base leading-7 text-airt-primary hover:text-airt-secondary'>
                      Learn more →
                    </a>
                  )}
                </dd>
      ...
      <div className='mx-auto mt-6 max-w-7xl px-6 lg:px-8 dark:bg-boxdark-2'>
        <footer
          ...
          className='relative border-t border-airt-font-base dark:border-gray-200/10 py-24 sm:mt-32'
        >
          ...
          <div className='flex items-start justify-end mt-10 gap-20'>
            ...
            <div>
              <h3 className='text-sm font-semibold leading-6 text-airt-font-base dark:text-white'>Company</h3>
              <ul role='list' className='mt-6 space-y-4'>
