...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={cn(
        'absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-airt-font-base duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0',
        {
          ...
          <div>
            ...
            <ul className='mb-6 flex flex-col gap-1.5'>
              ...
              <NavLink
                ...
                className={(isActive) =>
                  cn(
                    'group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-airt-font-base dark:hover:bg-meta-4',
                    {
                      'bg-airt-font-base dark:bg-meta-4': isActive,
                    }
                  )
                }
              >
